...
# Step 1: Generate Synthetic Loan Portfolio
# ============================================================
# WHY: Real bank data is confidential. Generating synthetic
# data is standard practice for model development and demos.
# The portfolio mimics a typical corporate/SME loan book.
# ============================================================

import pandas as pd
import numpy as np

# Set seed so results are reproducible every time you run this
np.random.seed(42)

NUM_LOANS = 500

# --- Industry sectors (mimics a diversified corporate book) ---
sectors = [
...
# --- Derive LGD from collateral ---
# LGD = Loss Given Default: how much of EAD is lost if borrower defaults
# More collateral = lower LGD. Floored at 10%, capped at 90%.
